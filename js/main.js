class HtmlHandler{
                        ...
                        <div class="card ">
                            <div class="team_image position-relative">
                                ...
                                <div class="team_image_overlay position-absolute ">
                                    ...
                                    <p class="text-black">` + String(categories[i]['strCategoryDescription']).substring(0,150) + `...</p>
                                </div>
                            </div>
	...
	AreaListHandler(data){
		...
		for(let i = 0;i < areas.length;i++){
			area_list += `
                    <div class="col-md-3 card" onclick="api_fetcher.Filter.filterByArea('` + areas[i]['strArea'] + `',(data) => {html_handler.areaFilterHandler(data)})">
